<footer class="w-full flex justify-center bg-amna-primary-100">
    <div class="w-amna-app text-white">
        <div class="grid grid-cols-3 py-8">
            <div>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati tenetur incidunt possimus illum quia enim nemo magni animi officia quibusdam, debitis corporis numquam delectus recusandae, sapiente nam aliquid neque reprehenderit.</p>
            </div>
            <div class="flex justify-center items-center">
                <a class="text-7xl font-serif text-white px-7" href="{{ route('welcome') }}">
                    <img class="h-32" src="{{ asset('logo_white.png') }}" alt="Logo da associação">
                </a>
            </div>
